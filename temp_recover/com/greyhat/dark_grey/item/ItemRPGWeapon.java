...
public class ItemRPGWeapon extends ItemSword implements IRPGItemContainer {
    ...
    /** All components attached to this weapon. */
    ...
    /** Components that modify item attributes (attack damage, speed, etc.). */
    ...
    /** The global ID of this RPG item. */
    private final String rpgItemId;
    
    /** Tracking key for Excel enchants */
    ...
    /**
     * Constructs a new RPG weapon with the given material and components.
     *
     * @param id         the unique string ID of this weapon
     * @param material   the tool material determining base damage and durability
     * @param components the full list of RPG components to attach to this weapon
     */
    ...
    //  Item Method Overrides 閳?Delegate to Components
    // 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓

    /**
     * Called when this weapon successfully hits an entity.
     *
