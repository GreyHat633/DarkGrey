...
public class DarkGrey
{
    ...
    public void postInit(final FMLPostInitializationEvent event) {
        ...
        final Boolean isDevEnv = Launch.blackboard.get("fml.deobfuscatedEnvironment");
    ...
    private void dumpEnchantments() {
        ...
        for (final Enchantment ench : Enchantment.field_77331_b) {
            if (ench != null) {
                ...
                obj.addProperty("id", (Number)ench.field_77352_x);
                obj.addProperty("name", StatCollector.func_74838_a(ench.func_77320_a()));
                obj.addProperty("unlocalizedName", ench.func_77320_a());
