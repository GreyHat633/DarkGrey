...
/**
 * V5: Fixes for Minecraft 3D extrusion and pull distance
 * - Remove anti-aliasing and soft glows (which cause Minecraft to extrude massive blocks)
 * - Make the bowstring crisp and thin
 * - Increase the pull distance to match vanilla's deep draw
 */
public class GenerateItanisPullingV5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Step 1: Find the bowstring line
        ...
        // Scale arrow  
        int arrowSize = (int)(W * 0.35); // Slightly larger arrow to be clearly visible
        ...
        // Increased max pull distance: from 0.11 to 0.28 (much deeper draw)
        ...
        for (int frame = 0; frame < 3; frame++) {
            ...
            // VERY IMPORTANT: Turn OFF anti-aliasing so Minecraft extrudes it cleanly
            g.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
            
            g.drawImage(bowBody, 0, 0, null);
            
            // Draw crisp bowstring - NO GLOW, NO BLUR
            float stringThickness = 6.0f; // Thin, sharp line (at 720px)
            g.setColor(new Color(0, 230, 255, 255)); // Solid bright cyan
