 ...
 *
 * <p>
 * Triggered by {@code LivingHurtEvent} on the Forge EventBus, NOT by an Item
 * method override. This is critical because 1.7.10's {@code ItemArmor} has no
 * {@code onHurt()} method — only the EventBus can intercept damage before it is applied.
 * </p>
 *
 * <p>
 * <b>Pipeline pattern:</b> Multiple {@code IOnHurt} components are chained.
 ...
 * {@code get_viewport().set_input_as_handled()} to consume or modify input.
 * </p>
 */
public interface IOnHurt {
     ...
     */
    float onHurt(ItemStack armorPiece, EntityLivingBase wearer, DamageSource damageSource, float incomingDamage);
}
