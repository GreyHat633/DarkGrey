 ...
 *
 * <p>
 * Counterpart to {@link IOnEquip}. Detected by the same {@code PlayerTickEvent}
 * comparison mechanism in {@code RPGCoreEventHandler}.
 * </p>
 *
 * <p>
 * In Godot terms, this is like connecting to the {@code tree_exited} signal —
 * it fires once when the node (armor piece) leaves the scene tree (player's armor slot).
 * This reliably handles all removal scenarios: manual unequip, death drops, inventory swaps.
 * </p>
 */
