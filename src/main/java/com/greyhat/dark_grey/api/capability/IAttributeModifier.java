 ...
 *
 * <p>
 * Attribute modifiers affect player stats like attack damage, movement speed, etc.
 * Called from the container's {@code getItemAttributeModifiers()} override.
 * </p>
 *
 * <p>
 * Note: In 1.7.10, {@code getItemAttributeModifiers()} does not receive an
 * {@code ItemStack} parameter. Components should use their own configured values
 * (set via {@code configure()}) rather than reading from the stack's NBT.
 * </p>
 *
 * <p>
 * In Godot terms, this is like a component modifying the parent node's exported
 * properties — the component can add or change attribute entries on the item.
 * </p>
 */
public interface IAttributeModifier {
     ...
     *
     * <p>
     * Common attribute names in 1.7.10:
     * </p>
     * <ul>
