 ...
 *
 * <p>
 * Triggered by {@code LivingDeathEvent} on the Forge EventBus.
 * Useful for soul-bound items, death prevention mechanics, or loot protection.
 * </p>
 *
 * <p>
 * In Godot terms, this is like connecting to a global {@code player_died} signal
 * that allows each equipped item's script to run cleanup or revival logic.
 * </p>
 */
